            ...
            <header className="bg-white shadow-sm sticky top-0 z-10">
                <div className="max-w-md mx-auto px-4 py-4">
                    <div className="flex justify-between items-center mb-3">
                        <h1 className="text-lg font-bold text-gray-800">동행빌리지 차량관리</h1>
                        <div className="flex items-center space-x-2">
                            <button
                                onClick={() => setIsGuideOpen(true)}
                                className="flex items-center text-gray-600 bg-gray-100 px-3 py-1.5 rounded-lg text-xs font-bold hover:bg-gray-200 transition-colors mr-1"
                            >
                            ...
                            <button
                                ...
                                className="text-gray-600 bg-white border border-gray-200 px-3 py-1.5 rounded-lg text-xs font-bold hover:bg-gray-50 transition-colors"
                            >
                                나의 요청
                            </button>
                            <button onClick={handleLogout} className="text-gray-500 p-2 hover:bg-gray-100 rounded-full">
                                <LogOut size={20} />
                            </button>
                        </div>
                    </div>
